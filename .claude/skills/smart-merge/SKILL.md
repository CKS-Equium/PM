---
name: smart-merge
description: Intelligent merge workflow with automatic branch detection, safety checks, flexible merge strategies, and conflict resolution guidance. Use when merging branches.
---
