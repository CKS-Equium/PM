---
name: smart-cleanup
description: Intelligent branch cleanup workflow that identifies and removes merged, stale, and unnecessary branches. Use after merges or periodically to maintain clean repository state.
---
