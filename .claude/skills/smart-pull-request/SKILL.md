...
description: Intelligent pull request workflow with quality gates (lint, type-check, tests, build), auto-fixing, PR description generation, and CI monitoring. Use when creating a pull request or submitting work for review.
---
...
**Dependencies:** Requires `gh` CLI (GitHub CLI) to be installed and authenticated.
