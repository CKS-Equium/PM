---
name: smart-branch
description: Intelligent branch creation workflow with proper naming conventions, type detection, and setup. Use when starting new work, creating a branch, or beginning a new feature.
---

# Smart Branch Skill

An intelligent branch creation workflow that starts a development session with proper branch naming and setup.
